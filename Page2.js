...
class Page2 extends Component{
  ...
  componentDidMount() {
    ...
    const fireRef = ref(db, 'House 1/fire/value');
  ...
  showFireAlert = () => {
    Alert.alert(
      'Fire Alert',
      'Fire has been detected! Please evacuate immediately.',
      [
              ...
              <View style={{marginTop:30}}>
                <View style={{
                  ...
                  <View style={{
                    ...
                    <Icon2 name="smoke" size={25} color="#15317E" />
                    </View>
                      <View style={{
                        justifyContent:'center',
                        marginLeft:10,
        ...
        <FlatGrid
          ...
          renderItem={({item, index}) => (
            ...
            style={{
                ...
                <Icon name="fire" size={65} color="#15317E" />
